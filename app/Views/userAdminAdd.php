                    ...
                    <form method="POST" action="" class="" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 row"><label for="fullName" class="col-sm-4 col-form-label form-label">Họ và tên</label>
                            <div class="col-md-8 col-12">
                                <input type="text" class="form-control" placeholder="Điền tên của bạn" id="fullName" name="fullname" value="<?= empty($_POST['fullname']) ? '' : $_POST['fullname'] ?>" fdprocessedid="51z174">
                        ...
                        <div class="mb-4 row"><label for="email" class="col-sm-4 col-form-label form-label">Email</label>
                            <div class="col-md-8 col-12">
                                <input type="email" class="form-control" placeholder="Email" id="email" name="email" value="<?= empty($_POST['email']) ? '': $_POST['email'] ?>" fdprocessedid="h64qu">
                        ...
                        <div class="mb-4 row"><label class="col-sm-4 form-label" for="phone">Số điện thoại</label>
                            <div class="col-md-8 col-12">
                                <input placeholder="Enter Phone" type="text" id="phone" name="phone" value="<?= empty($_POST['phone']) ?'' : $_POST['phone'] ?>" class="form-control" fdprocessedid="s4s7t8">
                        ...
                        <div class="mb-4 row"><label class="col-sm-4 form-label" for="password">Mật khảu</label>
                            <div class="col-md-8 col-12">
                                <input placeholder="Enter password" type="text" id="password" name="password" value="<?= empty($_POST['password']) ? '' : $_POST['password'] ?>" class="form-control" fdprocessedid="s4s7t8">
                        ...
                        <div class="mb-4 row"><label class="col-sm-4 form-label" for="country">Quyền</label>
                            <div class="col-md-8 col-12">
                                <select name="Quyen" class="form-control form-select" id="country" fdprocessedid="bccq5f">
                                    <option value="user" class="text-muted">user</option>
                        ...
                        <div class="mb-4 row"><label class="col-sm-4 form-label" for="addressLine">Địa chỉ </label>
                            <div class="col-md-8 col-12"><input placeholder="Nhập địa chỉ của bạn" name="address" value="<?=empty($_POST['address']) ? '' : $_POST['address']  ?>" type="text" id="addressLine" class="form-control" fdprocessedid="9h9onh"></div>
                        </div>
