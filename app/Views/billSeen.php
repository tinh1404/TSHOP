<div class="card w-100 mt-5">
    <div class="card-body p-4">
        ...
        switch ($trangthai) {
            case 'cho-xac-nhan':
                echo "<a href='" . APPURL . "admin/bill/submit/" . $bill['MaDH'] . "/chuan-bi-hang' class='btn btn-success'>Duyệt Đơn</a>";
                break;
            case 'chuan-bi-hang':
                echo "<a href='" . APPURL . "admin/bill/submit/" . $bill['MaDH'] . "/dang-giao-hang' class='btn btn-success'>Duyệt Đơn</a>";
                break;
            case 'dang-giao-hang':
                echo "<a href='" . APPURL . "admin/bill/submit/" . $bill['MaDH'] . "/giao-thanh-cong' class='btn btn-success'>Duyệt Đơn</a>";
                break;
