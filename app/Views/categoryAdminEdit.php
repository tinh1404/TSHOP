    ...
    <div class="my-8 row">
        <div class="col-xl-9 col-lg-8 col-md-12 col-12">
            <div class="card">
                ...
                <div class=" mb-6">
                    <h4 class="mb-4">Thay đổi thông tin danh mục</h4>
                </div>
                <div>
                    <form method="POST" action="" class="">
                        <div class="mb-4 row"><label for="category" class="col-sm-4 col-form-label form-label">Tên danh mục</label>
                            <div class="col-md-8 col-12">
                                <input type="text" class="form-control" placeholder="Điền tên của bạn" id="category" name="category" value="<?= empty($_POST['category']) ? $categoryId['TenDM'] : $_POST['category'] ?>" fdprocessedid="51z174">
